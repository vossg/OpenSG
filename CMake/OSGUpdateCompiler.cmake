...
IF(CMAKE_COMPILER_IS_GNUCC)
    ...
    IF(LINUX OR APPLE)
        ...
        MESSAGE(STATUS "got gcc ${OSG_GCC_VERSION}")
        ...
        IF(_OSG_ADD_FSLIB)
          ...
          IF(_CPPFSFOUND EQUAL -1)
            LIST(APPEND OSG_GLOBAL_DEP_LIBS CXX_FS_LIB)
          ENDIF()
        ELSE()
           LIST(REMOVE_ITEM OSG_GLOBAL_DEP_LIBS CXX_FS_LIB)
        ENDIF()
    ...
    STRING(REGEX REPLACE "-m[a-z][^ ]*" "" 
           CMAKE_CXX_FLAGS_PLAIN ${CMAKE_CXX_FLAGS})
    STRING(REGEX REPLACE "-m[a-z][^ ]*" "" 
           CMAKE_C_FLAGS_PLAIN ${CMAKE_C_FLAGS})

    SET(CMAKE_C_FLAGS_FULL   ${CMAKE_CXX_FLAGS})
    SET(CMAKE_CXX_FLAGS_FULL ${CMAKE_C_FLAGS}  )
